...
/**
 * ImplMergeSortStringAsc - реализация сортировки методом слияния для данных типа String
 * Данные сортируются по возрастанию
 *
 * @author Ilya Kaltygin
 */
public class ImplMergeSortStringAsc implements MergerSort<List<String>, String[]> {
     ...
     */
    @Override
    /* В метод приходит целый массив, неотсортированный*/
